...
export default {
    ...
    methods: {
        async getIngredientes() {
            const req = await fetch("https://lukasstranges.github.io/db__ingredientes/index.json");
        ...
        async creatBurger(e) {
            ...
            const req = await fetch("https://lukasstranges.github.io/db__ingredientes/burgers", {
                method: "POST",
